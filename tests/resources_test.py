...
def create_request(method_type, resource_path, request_dict=None):
...
class TestResources(BaseTestCase):
    ...
    def test_find(self):
        ...
        status, response, body = create_request('GET', url)
    ...
    def test_find_many(self):
        ...
        s1, r1, b1 = create_request('GET', url, request_dict)
        ...
        # find_all
        url = '/api/people'
        s1, r1, b1 = create_request('GET', url)
    ...
    def test_create(self):
        ...
        url = '/api/people'
        s1, r1, b1 = create_request('POST', url, request_dict)
        self.assertEqual(s1, '200 OK')
    ...
    def test_create_many(self):
        ...
        s1, r1, bs = create_request('POST', url, request_dict)
    ...
    def test_update(self):
        ...
        s1, r1, b1 = create_request('PUT', url, request_dict)
    ...
    def test_update_many(self):
        ...
        url = '/api/people'
        request_dict = {'people': [p1, p2]}
        s1, r1, b = create_request('PUT', url, request_dict)
    ...
    def test_delete(self):
        ...
        url = '/api/people/{}'.format(p1.key.id())
        s1, r1, b1 = create_request('DELETE', url)
    ...
    def test_delete_list(self):
        ...
        url = '/api/people'
        request_dict = {'ids': ids}
        s1, r1, b1 = create_request('DELETE', url, request_dict)
